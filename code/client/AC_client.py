...
RES_PATH = 'http://localhost:5002/user_details'
REDIRECT_URL = 'http://localhost:5000/callback'

CLIENT_ID = 'testing.com'
CLIENT_SECRET = 'dXg3cEpEazVKQVpYYmMxZDBmYzAtZjc4My00NzgzLTg3OGYtNGUzZjQwYzRjOTU3'
...
def main():
  ...
  print(r.text)
  print('*'*100)
  users_details = json.loads(r.text).get('results')
  print('users_details ==============> ',users_details)
  for cli in users_details:
    print('user deta in for',cli)

  return render_template('user_details.html', users_details = users_details)
